...
class RecipeViewModel(
    ...
    fun onSaveButtonClicked(title: String, author: String, category: String, content: List<Step>?) {
    ...
    override fun onAddFavoriteClicked(recipe: Recipe) = repository.addFavorite(recipe.id) // yes

    override fun onRemoveClicked(recipe: Recipe) = repository.delete(recipe.id) // yes
    ...
    override fun onRemoveStepClicked(step: Step) = repository.deleteStep(step) // yes
